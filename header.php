				...
				<div class="nav-box">
					...
					<ul class="nav-main-lst">
						...
						<li class="mnu5">
							<a href="#">직무교육 안내</a>
							<ul class="nav-sub-lst">
								<li><a href="/test/lecture_board/index.php?mode=list">##수강후기##</a></li>
								<!--<li><a href="#">서브메뉴</a></li>
								<li><a href="#">서브메뉴</a></li>
								<li><a href="#">서브메뉴</a></li>
								<li><a href="#">서브메뉴</a></li>
					...
					<?php 
						if($_SESSION['session_id'] != null){
								...
								if($_SESSION['session_id'] == "admin"){
										  echo "
										  <a>".$session_id."님</a>
										  <a href='/test/chklogout.php'>로그아웃</a>
										  <a href='/test/member/index.php?mode=modify'>내정보</a>
										  <a href='/test/admin/index.php'>admin페이지</a>";
								}else{
										  echo "
										  <a>".$session_id."님</a>
										  <a href='/test/chklogout.php'>로그아웃</a>
								...
								echo "<a href='/test/login.html'>로그인</a>
								<a href='/test/member/index.php?mode=step_01'>회원가입</a>
								<a href='#'>상담/고객센터</a>";
						}
					?>
				</div>
